...
@section('content')
    ...
    <div class="ibox-content" id="vista_app">
          <p>
      <?php echo $generales[0]['descripcion']; ?>
</p>
<form name="enviar_respuesta" action="{{ url("enviar-respuesta") }}" method="post">
<div class="form-group">
<?php foreach($opciones as $row){ ?>
<label class="checkbox-inline"> <input style="width:20px; height:20px;" type="checkbox" value="<?php echo $row->id; ?>" id="inlineCheckbox1"> <h3><strong><?php echo $row->nombre; ?></strong></h3> </label>
<?php } ?>
</div>
<div class="form-group"><label class="col-sm-2 control-label" style="margin-right: -100px;">Correo:</label>
<div class="col-sm-6"><input type="text" class="form-control"></div><div class="col-sm-6"></div>
</div><br /><br />
